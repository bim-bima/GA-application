...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">Tambah Status Follow Up</h6>
  </div>
  <div class="card-body">
    <form action="{{ route('master_statusfollowup.store') }}" method="POST" enctype="multipart/form-data" class="col-lg-6">
      ...
      <input type="text" class="mb-1 form-control @error('nama') is-invalid @enderror" name="msf_status" required>
      @error('nama')
