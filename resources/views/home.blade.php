                      ...
                      <div class="row">
                        ...
                        <div class="col-12 mb-2 px-4">
                          <div class="row justify-content-between">
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $kendaraan->mk_status }}</div>
                            <a class="btn-sm btn-info btn-circle" href="{{ route('app_kendaraan.show',$kendaraan->id) }}"  data-toggle="tooltip" data-placement="left" title="Info"><i class="fas fa-info-circle"></i></a>
                          </div>
                        </div>
                      </div>
                @endforeach
              ...
              <table class="table table-bordered border" id="dataTable" width="100%" cellspacing="0">
                ...
                @foreach ($booking as $riwayat)
                  <tr>
                    ...
                    <td> <a class="btn-sm btn-info btn-circle mb-xl-0 mb-1" href="{{ route('app_kendaraan.show',$riwayat->id) }}"  data-toggle="tooltip" data-placement="left" title="Info"><i class="fas fa-info-circle"></i> </a>
                    </td>
                  </tr>
                @endforeach
                </tbody>
