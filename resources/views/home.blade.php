              ...
              <div class="row">
                ...
                <div class="col-12" style="overflow-y: auto; max-height: 285px;">
                  <table class="table table-bordered border" id="dataTable" cellspacing="0">
                    <thead>
                      <tr>
                        <th class="col-6 px-2">Kendaraan</th>
                        <th class="col-5 px-2">Tanggal</th>
                        <th class="col-1 px-2">Detail</th>
                      </tr>
                    </thead>
                    <tbody>
                      @foreach ($booking as $riwayat)
                      <tr>
                        <td class="px-2">{{ $riwayat->namaKendaraan->mk_nama_kendaraan }}</td>
                        <td class="px-2">{{ $riwayat->ak_tanggal_mulai }}</td>
                        <td class="px-2"> 
