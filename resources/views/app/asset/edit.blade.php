...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
           <form action="{{ route('app_asset.update',$asset->id) }}" method="POST" enctype="multipart/form-data" class="col-lg-6">
           @csrf
           @method('put')
           ...
           <button class="btn btn-primary my-3"><a  href="{{ route('app_asset.index') }}" class="text-white text-decoration-none">kembali</a></button>
       </form>
      </div>
    </div>
@endsection
